        ...
        if object_id:
            ...
            if obj:
                ...
                if u:
                    ...
                    followers_count = getattr(u, 'followers_set', None).count() if hasattr(u, 'followers_set') else 0
                    following_count = getattr(u, 'following_set', None).count() if hasattr(u, 'following_set') else 0
